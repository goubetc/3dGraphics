...
void HierarchicalSphereRenderable::do_draw()
{
    //Location
...
void HierarchicalSphereRenderable::do_animate(float /*time*/) {}

HierarchicalSphereRenderable::~HierarchicalSphereRenderable()
{
