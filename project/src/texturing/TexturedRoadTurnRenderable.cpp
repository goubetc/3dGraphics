...
TexturedRoadTurnRenderable::~TexturedRoadTurnRenderable()
{
...
TexturedRoadTurnRenderable::TexturedRoadTurnRenderable(ShaderProgramPtr shaderProgram, const std::string& filename)
...
void TexturedRoadTurnRenderable::do_draw()
{
    //Location
...
void TexturedRoadTurnRenderable::do_animate(float time)
{

}

void TexturedRoadTurnRenderable::updateTextureOption()
{
...
void TexturedRoadTurnRenderable::do_keyPressedEvent( sf::Event& e )
{
...
void TexturedRoadTurnRenderable::setMaterial(const MaterialPtr& material)
{
    m_material = material;
}
